 ...
 * 
 * import com.example.demo.publish.constant.KafkaPublishConstant; import
 * com.example.demo.publish.entiry.Customer; import
 * com.fasterxml.jackson.databind.JsonSerializer;
 * 
 * @Configuration public class KafkaPublishConfig {
 * 
 * @Bean public ProducerFactory<String, Customer> produceFactory() { Map<String,
 * Object> configProp = new HashMap<String, Object>();
 * configProp.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG,
 * KafkaPublishConstant.HOST);
 * configProp.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG,
 ...
 * Customer>(configProp); }
 * 
 * @Bean(name = "kafkaTemplate") public KafkaTemplate<String, Customer>
 * kafkaTemplate() { return new KafkaTemplate<>(produceFactory()); }
 * 
 * @Bean public ConsumerFactory<String, Customer> consumerFactory() {
 * Map<String, Object> props = new HashMap<String, Object>();
 * props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG,
 * KafkaPublishConstant.HOST); props.put(ConsumerConfig.GROUP_ID_CONFIG,
 * KafkaPublishConstant.GROUP_ID);
 * props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG,
 * StringDeserializer.class);
 * props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG,
 * JsonDeserializer.class); return new DefaultKafkaConsumerFactory<>(props, new
 * StringDeserializer(), new JsonDeserializer<>(Customer.class)); }
 * 
